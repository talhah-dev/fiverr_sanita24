...
<footer class="w-full mx-auto max-w-7xl p-5 mt-10">
  <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 md:gap-10">
    ...
    <div data-aos="fade-up" class="md:col-span-2 md:pr-16">
      ...
      <div class="mt-7 flex items-center gap-3 flex-wrap">
        ...
        <a href="mailto:info@kanalwurm24.de"
           class="inline-flex items-center gap-2 text-sm text-zinc-700 hover:text-zinc-900 transition">
          <i class="fa-solid fa-envelope text-[#0165a1]"></i> info@kanalwurm24.de
        </a>
      </div>
    </div>
    ...
    <div data-aos="fade-up" data-aos-delay="100">
      ...
      <ul class="mt-5 space-y-3 text-zinc-700 font-medium">
        <li><a href="/index.html#home" class="hover:text-[#0165a1]">Home</a></li>
        <li><a href="/services.html" class="hover:text-[#0165a1]">Leistungen </a></li>
        <li><a href="/standorte.html" class="hover:text-[#0165a1]">Standorte </a></li>
        <li><a href="/galerie.html" class="hover:text-[#0165a1]">Galerie </a></li>
        <li><a href="/kontakt.html" class="hover:text-[#0165a1]">Kontakt </a></li>
        ...
        <li><a href="/ueber-uns.html" class="hover:text-[#0165a1]">Über uns </a></li>
      </ul>
    </div>
    ...
    <div data-aos="fade-up" data-aos-delay="200">
      ...
      <ul class="mt-5 space-y-3 text-zinc-700 font-medium">
        <li><a href="/services.html#abfluss" class="hover:text-[#0165a1]">Abflussreinigung (Bad · Küche · WC)</a></li>
        <li><a href="/services.html#rohr" class="hover:text-[#0165a1]">Rohrreinigung</a></li>
        <li><a href="/services.html#kanal" class="hover:text-[#0165a1]">Kanalreinigung</a></li>
        <li><a href="/services.html#hd" class="hover:text-[#0165a1]">Hochdruckspülung</a></li>
        <li><a href="/services.html#tv" class="hover:text-[#0165a1]">TV-Kanalinspektion</a></li>
        <li><a href="/services.html#zisternen" class="hover:text-[#0165a1]">Zisternenreinigung</a></li>
        <li><a href="/services.html#dachrinne" class="hover:text-[#0165a1]">Dachrinne &amp; Fallrohr</a></li>
      </ul>
    </div>
    ...
    <div data-aos="fade-up" data-aos-delay="300">
      ...
      <ul class="mt-5 space-y-3 text-zinc-700 font-medium">
        <li class="flex items-center gap-2">
          ...
          <a href="tel:+4915121711109" class="hover:text-[#0165a1]">(+49) 151 217 111 09</a>
        </li>
        <li class="flex items-center gap-2">
          <i class="fa-solid fa-envelope text-[#0165a1]"></i>
          <a href="mailto:info@kanalwurm24.de" class="hover:text-[#0165a1]">info@kanalwurm24.de</a>
        </li>
        <li class="flex items-center gap-2">
  ...
  <div class="mt-8 border-t border-zinc-200 pt-4">
    <p class="text-center text-zinc-600 mt-4">
      Copyright © <span id="copyright"></span> Kanalwurm Rohrreinigung. Alle Rechte vorbehalten.
    </p>
  </div>
</footer>
